...
if __name__ == '__main__':
    ...
    train_decoder(decoder=decoder, encoder=bert_encoder, train_dataloader=train_dataloader,
                  val_dataloader=val_dataloader, num_epochs=training_config['num_epochs'], device=device)
